...
ALTER TABLE INVENTORY ADD VEN_ID　INT;
...
ALTER TABLE SALES_ORDER ADD EMP_NUM INT;/* ADD SALES_ORDER_LINE FOREIGN KEY*/
...
ALTER TABLE BILL_OF_LADING ADD SHIP_NUM INT;  
...
ALTER TABLE SALES_ORDER ADD CUS_ID VARCHAR(10);
ALTER TABLE INVENTORY ADD LAD_NUM　INT;
ALTER TABLE SALES_ORDER ADD FOREIGN KEY(CUS_ID) REFERENCES CUSTOMER ON UPDATE CASCADE;
ALTER TABLE INVENTORY ADD FOREIGN KEY(LAD_NUM) REFERENCES BILL_OF_LADING ON UPDATE CASCADE;
...
ALTER TABLE INVENTORY ADD BANK_CODE VARCHAR(10);
ALTER TABLE INVENTORY ADD FOREIGN KEY(BANK_CODE) REFERENCES BANK ON UPDATE CASCADE;
...
ALTER TABLE INVENTORY ADD EMP_NUM INT;
ALTER TABLE INVENTORY ADD FOREIGN KEY(EMP_NUM) REFERENCES BANK ON UPDATE CASCADE;
